 ...
 */
fbuilderjQuery =
  typeof fbuilderjQuery != "undefined" ? fbuilderjQuery : jQuery.noConflict();
(function (factory) {
  if (typeof define === "function" && define.amd) {
    define(["fbuilderjQuery"], factory);
  } else if (typeof module === "object" && module.exports) {
    module.exports = factory(require("fbuilderjQuery"));
  } else {
    factory(fbuilderjQuery);
  }
})(function ($) {
  $.extend($.fn, {
  ...
  $.extend($.validator, {
    ...
    prototype: {
      ...
      defaultMessage: function (element, rule) {
        ...
        var message = this.findDefined(
            ...
            (this.messages && this.messages[rule.method]) || undefined,
    ...
    normalizeAttributeRule: function (rules, type, method, value) {
      if (
        ...
        if (!/^\s*$/.test(value)) value = Number(value);
        if (isNaN(value)) {
          value = undefined;
        }
      }
